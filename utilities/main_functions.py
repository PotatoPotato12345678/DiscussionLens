...
# ------------------------------------------------------------------
#
# Main functions are ONLY called inside main_functions.py
#
# ------------------------------------------------------------------

from utilities.global_constant import TRANSCRIPT_JSON_FILENAME,KEYWORD_EXTRACTION_MAIN_CONTEXT, MODEL, OVERALL_EXTRACRTED_KEYWORDS_JSON_FILENAME
from utilities.small_functions import SmallFunctions
from utilities.type_def import TranscriptType, Output_For_ChatGPT_Keyword_Extraction
...
class MainFunctions:
    ...
    class Keyword_Extraction:
        ...
        def save_keywords(keywords: Output_For_ChatGPT_Keyword_Extraction, filename=OVERALL_EXTRACRTED_KEYWORDS_JSON_FILENAME) -> None:
            with open(filename, "w", encoding="utf-8") as f:
